...
function Index() {
  ...
  return (
    <div className="container-home container mx-auto w-full h-full flex flex-col items-center content-center gap-4">
      <div className="max-w-3xl w-full p-10 flex flex-col gap-10">
        <div className="w-full flex items-center gap-2">
          <ElectronIcon />
          <p className="text-5xl font-bold">Electron starter</p>
        </div>
